...
namespace WindowsFormsApplication1
{
    public partial class Form3 : Form
    {
        ...
        {
            string connstr = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\kcy\Desktop\综合\Database1.accdb";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
             try{
                ...
                string ssss = Class1.datat;
                string sql = "insert into data1 values('" + ss + "','" + sss + "','" + ssss + "')";
