...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void buttlon_moseHove(object sender, EventArgs e)
        {
            button2.BackgroundImage = Properties.Resources.Image2;
        }
        private void buttlon_moseleave(object sender, EventArgs e)
        {
            if (ButtonStatue)
            {
                button2.BackgroundImage = Properties.Resources.Image4;
            }
            else
            {
                button2.BackgroundImage = Properties.Resources.Image3;
